 ...
 */
public class BeaconTaskMonth extends AsyncTask<Void, Void, String> {
    private OnSendListener mListener;
    private String mSiteId, mDate;

    private final String TAG = "!!@@BeaconTaskMonth";
     ...
     * @param l
     */
    public BeaconTaskMonth(String siteId, String date, OnSendListener l) {
        Log.i(TAG, "BeaconTaskMonth : " + siteId + ", " + date);
        mSiteId = siteId;
        mDate = date;
        mListener = l;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            try {
                String urlTemp = "http://14.63.163.204:5000/history/get/month/" + mSiteId + "/" + mDate;
                URL url = new URL(urlTemp);
                Log.i(TAG, "BeaconTaskMonth - URL : " + urlTemp);
                // URLConnection 생성
