 ...
 */
public class BeaconTaskDelete extends AsyncTask<Void, Void, String> {
     ...
     * @param l
     */
    public BeaconTaskDelete(String siteId, OnSendListener l) {
        Log.i(TAG, "BeaconTaskAdd - uuid : " + siteId);
        mSiteId = siteId;
        mListener = l;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            try {
                URL url = new URL("http://14.63.163.204:5000/site/del/" + mSiteId);
                // URLConnection 생성
