 ...
 */
public class BeaconTaskSend extends AsyncTask<Void, Void, String> {
    private OnSendListener mListener;
    private String mSiteId, mData;

    private final String TAG = "!!@@BeaconTaskSend";
     ...
     * 클래스 생성자
     *
     * @param data BeaconData
     * @param l
     */
    public BeaconTaskSend(String siteId, String data, OnSendListener l) {
        Log.i(TAG, "BeaconTaskSend - BeaconData : " + siteId + ", " + data);
        mSiteId = siteId;
        mData = data;
        mListener = l;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            try {
                URL url = new URL("http://14.63.163.204:5000/history/add/" + mSiteId + "/" + mData);
                // URLConnection 생성
